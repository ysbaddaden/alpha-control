...
//Eventable.addEvents(UI.ListPicker, ['activate', 'deactivate', 'select']);

UI.ListPicker.prototype.initListPicker = function(input, options)
{
  this.setOptions({autoMarkFirst: false});
  ...
  this.input.addEventListener('keypress', this.keypress_cb.bind(this), false);
  this.input.addEventListener('keyup',    this.keyup_cb.bind(this),    false);
